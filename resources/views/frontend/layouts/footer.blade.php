		...
		<div class="footer-top section">
			<div class="container mt-5 mb-5">
				@php
					...
					$store = \App\StoreModal::with(['address' => function ($query){	$query->with(['country', 'state', 'city']);	}], 'social_links')->where('id', $store_info->id)->first();
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="text">{{ $store->short_description }}</p>
							<p class="call">Got Question? Call us 24/7<span class="mt-2"><a href="tel:{{ $store->phone }}">{{ $store->phone }}</a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							...
							<ul>
								...
								<li><a href="{{url('/'.$last_slug.'/about-us')}}">About Us</a></li>
								{{-- <li><a href="#">Faq</a></li> --}}
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									<li>{{ $store->area }}</li>
									<li>{{ $store->address->city->name }}, {{ $store->address->state->name }}, {{ $store->address->country->name }}.</li>
									<li>{{ $store->email }}</li>
									<li>{{ $store->phone }}</li>
								</ul>
							</div>
