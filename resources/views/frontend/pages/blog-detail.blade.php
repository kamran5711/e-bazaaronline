...
@section('title','E-BAZAAR || Blog Detail page')
@section('page-title','E-BAZAAR || Blog Detail page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Post Detail Page</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-12">
                    <div class="blog-single-main">
                        <div class="row">
                            <div class="col-12">
                                <div class="image">
                                    <img src="{{ asset('images/posts/'.$post->photo )}}" alt="{{$post->photo}}" class="img img-responsive">
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        ...
                                                        <textarea name="comment" id="comment" rows="10" placeholder="Write your Comments" required="required"></textarea>
                        ...
                        <div class="single-widget recent-post">
                            ...
                            @foreach($recent_posts as $post)
                                ...
                                <div class="single-post">
                                    ...
                                    <div class="content">
                                        <h5><a href="{{ route('blog.detail', ['post_slug' => $post->slug, 'slug' => $slug]) }}">{{$post->title}}</a></h5>
                                        <ul class="comment">
