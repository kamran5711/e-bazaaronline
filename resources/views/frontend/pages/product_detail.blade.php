...
@section('page-title',$product_detail->slug)
@section('meta')
<meta charset="utf-8">
...
<meta property="og:url" content="{{ URL($last_slug . '/' . 'product-detail' . '/' . $product_detail->slug) }}">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            {{-- <div class="product-gallery">
                                ...
                                <div id="content-wrapper">
                                    <div class="column">
                                        <img id="featured"
                                            src="{{asset('images/products/'.$product_detail->photo)}}"><br><br>
                                        <div id="slide-wrapper">
                                            ...
                                            <div id="slider">
                                                ...
                                                <img class="thumbnail"
                                                    src="{{ asset('images/products/'.$product_image->image)}}">
                                                @endforeach
                                            </div>
                            ...
                            <div class="exzoom" id="exzoom">
                                ...
                                <div class="exzoom_img_box">
                                    <ul class='exzoom_img_ul'>
                                        {{-- @php dd($product_detail->images);exit; @endphp; --}}
                                    <li>
                                        <img src="{{asset('images/products/'.$product_detail->photo)}}" />
                                    </li>
                                    @foreach($product_detail->images as $product_image)
                                        <li><img src="{{ asset('images/products/'.$product_image->image)}}"/></li>
                                    @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="product-des">
                                ...
                                <div class="color">
                                    <ul>
                                        ...
                                        <table>
                                            @php
                                                $sizes = $product_detail->productStock->groupBy('size_id');
                                                $colors = $product_detail->productStock->groupBy('color_id');
                                            @endphp
                                            <tr>
                                                <td class="pr-2">
                                                    <label>Sizes :</label>
                                ...
                                <div class="product-buy">
                                    <form action="{{route('single-add-to-cart')}}" method="POST">
                                        ...
                                        <p class="cat">Category :<a href="{{ url('/'. $last_slug. '/product-category'. '/' . $product_detail->category_id) }}"> {{ $product_detail->category->title }}</a>
                                        </p>
                                        @if($product_detail->sub_category_id)
                                        <p class="cat mt-1">Sub Category :<a href="{{route('product-sub-category',[$last_slug, $product_detail->sub_category_id])}}">{{ $product_detail->sub_category->title }}</a>
                                        </p>
                                        @endif
                                        <p class="availability">Stock : @if($product_detail->productStock->sum('stock') > 0)<span
                                                class="badge badge-success">{{ $product_detail->productStock->sum('stock') }}</span>@else <span
                                                class="badge badge-danger">{{ $product_detail->productStock->sum('stock') }}</span> @endif</p>
                                        </div>
                                <!--/ End Product Buy -->
                            </div>
                        </div>
                                                ...
                                                <div class="comment-review">
                                                    ...
                                                    <div class="review-inner">
                                                        ...
                                                        <form class="form" method="post"
                                                            ...
                                                            <input type="hidden" name="last_slug" value="{{$last_slug}}" />
                                                            <div class="row">
                                                        ...
                                                        <p class="text-center p-5">
                                                            You need to <a href="{{route('login')}}"
                                                                ...
                                                                style="color:blue"
                                                                href="{{ URL($last_slug .'/user/register') }}"
                                                                >Register</a>
                                                        </p>
                                                        <!--/ End Form -->
                                                        @endauth
                        ...
                        <form action="{{route('add-to-cart', $product_detail->id)}}" method="POST">
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{ URL($last_slug . '/' . 'product-detail' . '/' . $product->slug) }}">
                                        <img class="default-img" src="{{ asset('images/products/'.$product->photo )}}"
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ URL($last_slug . '/' . 'product-detail' . '/' . $product->slug) }}"> {{ $product->title }} </a></h3>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <select name="size_id" class="pull-right" style="display: none;">
                                            @foreach($product->productStock as $ps)
                                                <option value="{{$ps->size->id}}">{{$ps->size->title}} </option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name='choice_id' class="pull-right" style="display: none;">
                                            @foreach($product->productStock as $ps)
                                                <option value="{{$ps->color->id}}">{{$ps->color->title}} </option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
