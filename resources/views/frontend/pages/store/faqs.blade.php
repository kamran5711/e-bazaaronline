...
#accordion .panel-body p {
	...
	<div class="container mb-5" style="min-height: 350px!important;">
		...
		<div class="row">				
		  <div class="col-md-12">
			...
			@else
			<h4 class="text-info text-center mt-5">No FAQS are added yet, please add some.</h4>
			@endif
		  </div><!--- END COL -->		
		</div><!--- END ROW -->			
	  </div>
