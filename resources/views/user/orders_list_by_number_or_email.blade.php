...
@section('main-content')
    ...
    <section class="m-5">
        <div class="container">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @foreach($orders as $order)   
                        <tr>
                            ...
                            <td>
                                <a href="{{ URL($store_slug . '/' . 'order-details' . '/' . $order->id)}}" class=""  data-toggle="tooltip" title="view" data-placement="bottom"><i class="ti-eye"></i></a>
            ...
            @else
                <h6 class="text-center">We don't have any order with spacify criteria, please try with different!</h6>
            @endif
        </div>
    </section>
@endsection
