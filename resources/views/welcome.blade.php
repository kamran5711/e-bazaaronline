                            ...
                            <div class="col-md-7" id="bodyData">
                                <form class="form-wrap mt-4" action="">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <input type="text" name="search" class="btn-group1 rounded-0 search-box-top"
                                            placeholder="Type to search for any store..." required />
                        ...
                        <div class="col-md-4">
                            ...
                            Business </a> --}}
                                <div class=" d-flex justify-content-center">
                                    <a href="{{ url('store') . '/' . $value->slug }}" class="btn btn-primary rounded-0 pl-5 pr-5">Visit Bussiness</a>
                                </div>
