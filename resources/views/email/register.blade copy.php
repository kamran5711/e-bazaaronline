...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h3 class="heading">Dear {{$user['person_name']}}<b></b></h3>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <h4 class="heading">We are pleased to confirm that your business  {{ $user['your_business'] }}, is now registered on our portal. </h4>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
