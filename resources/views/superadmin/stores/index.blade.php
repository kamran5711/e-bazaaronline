                        ...
                        @foreach($user as $user)
                            <tr>
                                ...
                                <td >
                                        ...
                                        <a class="btn @if($user->status=='1') btn-success @else btn-danger @endif" style="color:white;"  class="btn btn-sm btn-wave"   data-toggle="modal" data-target="#myModal{{$user->id}}" ><i class="fa fa-toggle-on" aria-hidden="true">@if($user->status=='1')Active @else Inactive @endif</i></a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                            <ul class="link-list-plain">
                                                <li>
                                                    <a href="{{route('user.show', ['id'=> $user->id])}}" class="icon ni ni-eye btn btn-dim btn-sm btn-primary">View</a></li>
                                                <li>
                                                <li>
                                    ...
                                    @endphp
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('user.enable',['id' => $user->id])}}" method="get">
                                                    @csrf
                                                    ...
                                                    <div class="form-group mb-1 mt-3">
                                                        <label for="">Modules</label> <br>
                                                        <label for="shop_{{$user->id}}">
                                                            <input type="checkbox" name="modules[shop]" id="shop_{{$user->id}}" value="1" {{(isset($user->modules) && $user->modules['shop'] == 1) ? "checked" :  ""}}>
                                                            Shop
                                                        </label>
                                                        <label for="app_{{$user->id}}">
                                                            <input type="checkbox" name="modules[app]"  id= "app_{{$user->id}}" value="1" {{(isset($user->modules) && $user->modules['app'] == 1) ? "checked" :  ""}}>
                                                            Mobile App
                                                        </label>
                                                    </div>
                                                    <div class="mb-3">
