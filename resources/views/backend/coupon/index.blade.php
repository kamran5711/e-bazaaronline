 ...
 <div class="card shadow m-3">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @foreach($coupons as $coupon)   
                <tr>
                    ...
                    <td>
                      @php
                        $date_label = "<span class='badge badge-info'>No expiry date</span>";
                        if($coupon->expiry_date){
                          $newDateFormat1 = date('Y-m-d', strtotime($coupon->expiry_date));
                          $newDateFormat2 = date('Y-m-d', strtotime(now()));
                          $date_label = "<span class='badge badge-danger'>$coupon->expiry_date</span>";
                          if($newDateFormat1 >= $newDateFormat2){
                            $date_label = "<span class='badge badge-success'>$coupon->expiry_date</span>";                            
                          }
                        }
                        echo $date_label;
                      @endphp
        ...
        @else
          <h6 class="text-center">No Coupons are added yet, Please add some coupons.</h6>
        @endif
      </div>
    </div>
</div>
