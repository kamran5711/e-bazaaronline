...
@section('main-content')
 ...
 <div class="card shadow m-3">
    ...
    <div class="card-header py-3">
      <h5 class="m-0 font-weight-bold text-primary float-left">Banners List</h5>
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>{{$banner->slug}}</td>
                    <td>
                    <img  src="{{ asset('products/images/banners/'.$banner->photo) }}"
        ...
        @else
          <h6 class="text-center">No banners are added yet, please add some.</h6>
        @endif
      </div>
    </div>
</div>
