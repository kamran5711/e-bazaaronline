 ...
 <div class="card shadow m-3">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @foreach($posts as $post)   
                <tr>
                    ...
                    <td>
                      @foreach($post->post_tags as $pt)
                        {{ $pt->tag->title. ", " }}
                      @endforeach
                    </td>
                    <td>
                        @if($post->photo)
                            <img src="{{ asset('images/posts/'.$post->photo )}}" class="img-fluid zoom" style="max-width:80px" alt="{{$post->photo}}">
                        @else
        ...
        @else
          <h6 class="text-center">No posts are added yet, please add some posts.</h6>
        @endif
      </div>
    </div>
</div>
