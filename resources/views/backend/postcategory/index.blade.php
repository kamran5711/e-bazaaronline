...
@section('main-content')
 ...
 <div class="card shadow m-3">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Category</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No Post Category are added yet, Please add some post's category.</h6>
        @endif
      </div>
    </div>
</div>
