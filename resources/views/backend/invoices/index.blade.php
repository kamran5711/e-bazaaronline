...
@section('main-content')
  ...
  <div class="card shadow m-3">
    <div class="card-header bg-primary text-white rounded-0">
      <h6 class="m-0 font-weight-bold float-left">All Invoices</h6>
    </div>
    <div class="card-body">
      <div class="row">
          <div class="col-md-12">
                  ...
                  <tr>
                    ...
                    <td>
                      @switch($invoice->status)
                          @case(1)
                              <span class="text-primary">Pending <sup><small>(Admin)</small></sup></span>
                              @break
              
                          @case(2)
                              <span class="text-success">Approved <sup><small>(Admin)</small></sup></span>
                              @break
              
                          @default
                              <span class="text-info">Pending <sup>(Store)</sup></span>
                      @endswitch
                    </td>
