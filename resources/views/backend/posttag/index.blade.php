...
@section('main-content')
 ...
 <div class="card shadow m-3">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Tag Lists</h6>
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Tag</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No Post Tag found are added yet, Please add some post's tag.</h6>
        @endif
      </div>
    </div>
</div>
